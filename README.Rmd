...
# PMPLNFA
Parsimonious Finite Mixtures of Multivariate Poisson-Log Normal Factor Analyzers (PMPLNFA) for Clustering Count Data
...
`PMPLNFA` repository welcomes issues, enhancement requests, and other contributions. To submit an issue, use the [GitHub issues](https://github.com/anjalisilva/MPLNClust/issues).
