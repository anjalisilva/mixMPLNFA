...
``` r
nrow(simDataUUU$`dataset=1`$dataset) # 2000 observations
ncol(simDataUUU$`dataset=1`$dataset) # 9 dimensions
class(simDataUUU$`dataset=1`$dataset) # matrix 
typeof(simDataUUU$`dataset=1`$dataset) # integer
summary(simDataUUU$`dataset=1`$dataset) # summary of data
dim(simDataUUU$`dataset=1`$dataset) # 2000 x 9
```
