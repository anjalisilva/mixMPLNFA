# 26 October 2017
# testing for G=4:7, q=1:3, models=(8)
...
G_testing = c(4:7) # total number of cluster sizes to test 
...
results8=results2
save.image("FAMPLN_26Oct2017_nestedparallel_bi2016data_g=4to7_8.RData")
