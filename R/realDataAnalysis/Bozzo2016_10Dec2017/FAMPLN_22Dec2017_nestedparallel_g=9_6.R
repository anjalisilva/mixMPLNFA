# 22 Dec November 2017
# testing for G=9, q=1:3, models=(6)
...
G_testing = c(9:9) # total number of cluster sizes to test 
...
save.image("FAMPLN_22Dec2017_nestedparallel_g=9_6.RData")
