# 14 October 2017
# threshold outer = 10
# Running only CCU for G=1:3, q=1:3, models = CCU dataset1
...
save.image("FAMPLN_17September2017_g2q2CCU_nestedparallel_simdata2_d10_6.RData")
...
#save.image("FAMPLN_09October2017_g2q2CCU_nestedparallel_simdata_2.R.RData")
