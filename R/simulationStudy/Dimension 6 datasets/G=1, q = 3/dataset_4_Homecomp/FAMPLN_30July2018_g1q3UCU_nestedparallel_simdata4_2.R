# 30 July 2017
# UCU model dataset run for G=1:3 and q=1:3, models = 2
...
#simdata2<-quantile(datasets_FA[[2]]$dataset,prob=seq(0.5,0.95,by=0.01))
...
I_testing = c(4:4) # total number of datasets to test
...
save.image("FAMPLN_30July2018_g1q3UCU_nestedparallel_simdata_2_4.RData")
...
#save.image("FAMPLN_01Oct2017_g2q2UCU_nestedparallel_simdata.RData")
