# 26 Jan 2018
# UCU model dataset run for G=1:3 and q=1:3, models = 6
...
models_testing = c(6) # total number of models
...
save.image("FAMPLN_30July2018_g1q3UCU_nestedparallel_simdata_6_4.RData")
