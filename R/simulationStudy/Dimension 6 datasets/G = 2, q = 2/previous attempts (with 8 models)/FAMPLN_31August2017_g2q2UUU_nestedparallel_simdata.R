...
# alter threshold_outer = 10
# alter number of observations
# init_iterations=3
...
N1 = 100 # biological samples e.g. genes
...
results <-
  ...
  foreach(m=models_testing, .inorder=FALSE) %dopar% { # for each model
    set.seed(b)
    obj =  main_mpln(y=datasets_FA[[b]]$dataset, G=a, n_chain=3, numb_iterations=1000, membership=datasets_FA[[b]]$truemembership, init_method="kmeans", init_iterations=1, normalize="TMM", modelname=modelnames_consider[m], q=c)
  }
save.image("FAMPLN_17September2017_g2q2UUU_nestedparallel_simdata.RData")
