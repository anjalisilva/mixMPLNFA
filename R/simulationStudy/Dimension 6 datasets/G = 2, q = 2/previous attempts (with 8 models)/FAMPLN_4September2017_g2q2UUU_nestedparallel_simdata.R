# 4 September 2017
# re simulating data, specifically for q=2 model 
# threshold_outer changed to 10 instead of 2

# 11 September 2017
# Detected a bug. If UUU model is selected, then need to output times G lambda
# and times G Psi. The problem is in final_results function, not the main algorithm!
#allresults = dataset[[1]][[1]][[1]]$allresults  "SHOULD BE" allresults = dataset
...
N1 = 50 # biological samples e.g. genes
...
save.image("FAMPLN_4September2017_g2q2UUU_nestedparallel_simdata.RData")
...
#results
#finalresults$dataset1$allresults[[1]][[1]][[2]]
