# 26 September 2017
# testing UUU model for G=1:3, q=1:3
...
### Mu ###
true_mu11 = c(6,5.5,6,6,6,6)  
true_mu21 = c(1,1,1,1,1,1) 
...
models_testing = c(8) # total number of models
...
save.image("FAMPLN_26September2017_g2q2UUU_nestedparallel_simdata.RData")
...
toput = list(one = results, two=results2, three=results3, four=results4)

#results
finalresults = downstream_analysis(allresults=toput, G=G_testing, modelnames=modelnames_consider, models=models_testing, q=q_testing)
save.image("FAMPLN_26September2017_g2q2UUU_nestedparallel_simdata.RData")
