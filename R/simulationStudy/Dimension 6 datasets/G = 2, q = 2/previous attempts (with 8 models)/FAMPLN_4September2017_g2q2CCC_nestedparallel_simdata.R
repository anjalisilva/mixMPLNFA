...
# threshold_outer increased to 10

# 11 Sept 2017
# bug fixed
# not working. UCC model is selected.
...
### Mu ###
true_mu11 = c(6,6,6,6,6,6)  
true_mu21 = c(2,2,2,2,2,2) 
...
save.image("FAMPLN_4September2017_g2q2CCC_nestedparallel_simdata.RData")
